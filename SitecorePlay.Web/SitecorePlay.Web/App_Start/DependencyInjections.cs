...
using SitecorePlay.Web;
using SitecorePlay.Web.Helpers;
using WebActivatorEx;

[assembly: PostApplicationStartMethod(typeof(DependencyInjections), "Initialize", Order = 100)]

namespace SitecorePlay.Web
{
    public static class DependencyInjections
    {
        public static void Initialize()
        {
            ...
            container.Register<TwitterHelper>();
